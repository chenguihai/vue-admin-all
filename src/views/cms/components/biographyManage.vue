<template>
  <div class="headerForm">
    <el-form :inline="true" :model="form" size="small">
      ...
      <el-form-item label="传记名称">
        <el-input class="w_120" placeholder="传记名称" v-model="form.case_name" clearable/>
      </el-form-item>
    ...
    <el-table :data="list"
      ...
      <el-table-column prop="store_name" label="店铺名称" min-width="120" align="center"/>
      <el-table-column label="媒主传记名称/缩略图" min-width="300" align="center">
      ...
      <el-table-column fixed="right" label="操作" min-width="220" align="center">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="text">
            <a target="_blank"
               :href="`/case-biog/${scope.row.id}?id=${scope.row.store_id}&type=biog&sign=${sign}` | prefixUrlF">
              详情
            </a>
          </el-button>
          <el-button size="mini" type="text" @click="downloadFile(scope.row.id)">
              下载文件
          </el-button>
        </template>
      </el-table-column>
